...
axs[1][1].plot(df_ssp.Year, df_ssp.var"total_amoc26.5N_g01ssp245bgcLR", color=legend_colors[2], linewidth=3)
axs[1][1].plot(df_ssp.Year, df_ssp.var"total_amoc26.5N_u01ssp245bgcLR", color=legend_colors[3], linewidth=3)
axs[1][1].plot(df_ssp.Year, df_ssp.var"total_amoc26.5N_g03ssp245bgcLR", color=legend_colors[4], linewidth=3)
axs[1][1].plot(df_ssp.Year, df_ssp.var"total_amoc26.5N_u03ssp245bgcLR", color=legend_colors[5], linewidth=3)
axs[1][1].plot(df_ssp.Year, df_ssp.var"total_amoc26.5N_g05ssp245bgcLR", color=legend_colors[6], linewidth=3)
axs[1][1].plot(df_ssp.Year, df_ssp.var"total_amoc26.5N_u05ssp245bgcLR", color=legend_colors[7], linewidth=3)
...
axs[1][0].plot(df_pct.Year.-1850, df_pct.var"total_amoc26.5N_1pctbgcLR", color=legend_colors[1], linewidth=3)
axs[1][0].plot(df_pct.Year.-1850, df_pct.var"total_amoc26.5N_g011pctbgcLR", color=legend_colors[2], linewidth=3)
axs[1][0].plot(df_pct.Year.-1850, df_pct.var"total_amoc26.5N_u011pctbgcLR", color=legend_colors[3], linewidth=3)
axs[1][0].plot(df_pct.Year.-1850, df_pct.var"total_amoc26.5N_g031pctbgcLR", color=legend_colors[4], linewidth=3)
axs[1][0].plot(df_pct.Year.-1850, df_pct.var"total_amoc26.5N_u031pctbgcLR", color=legend_colors[5], linewidth=3)
axs[1][0].plot(df_pct.Year.-1850, df_pct.var"total_amoc26.5N_g051pctbgcLR", color=legend_colors[6], linewidth=3)
axs[1][0].plot(df_pct.Year.-1850, df_pct.var"total_amoc26.5N_u051pctbgcLR", color=legend_colors[7], linewidth=3)
